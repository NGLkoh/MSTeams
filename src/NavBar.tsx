...
export default function NavBar() {
  ...
  return (
    <Navbar bg="red" variant="dark" expand="md" fixed="top" style={{ backgroundColor: '#0078d4' , marginBottom: '5rem' , position: 'relative'}}>
      <Container>
          ...
          <Nav className="me-auto" navbar>
            ...
            <AuthenticatedTemplate>
              <NavItem>
               ...
               <NavItem>
                <RouterNavLink to="/TeamsMeeting" className="nav-link">Teams Meeting</RouterNavLink>
              </NavItem>
            </AuthenticatedTemplate>
          </Nav>
